...
const INVALID_USERS = {
    DEFAULT: getUser ({username: undefined, email: undefined, password: undefined}),
        ...
        Object.entries(INVALID_USERS).forEach((testCase) => {
            ...
            describe(key, () => {
                test(key, async () => {
                    ...
                    //expect(res.body.message).toEqual('Please provide a valid username or password');
                })
            })
    ...
    describe('fails with already signed up user', () => {
        Object.entries(VALID_USERS).forEach((testCase) => {
            ...
            describe(key, () => {
                ...
                beforeEach(async () => {
                    user = await createUser (payload.username, payload.email, payload.password)
        ...
        Object.entries(VALID_USERS).forEach((testCase) => {
            ...
            describe(key, () => {
                ...
                test(key, async () => {
                    ...
                    const isPasswordCorrect = await bcrypt.compare(payload.password, actual.password);
    ...
    describe('should delete the user account', () => {
        Object.entries(VALID_USERS).forEach((testCase) => {
            ...
            describe(key, () => {
                ...
                test(key, async () => {                   
                    const res = await request(app)
                    .delete('/api/deleteUser/?username=' + payload.username)
